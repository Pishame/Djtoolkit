...
const Header: React.FC<HeaderProps> = ({ onSearch, settings, activeTab, onTabChange, jobs, notifications, onLogout, onViewJob, isPremium }) => {
      ...
      <div className="flex items-center gap-6">
        <div className="flex items-center gap-4">
          ...
          <div className="relative" ref={profileRef}>
            ...
            {showProfileMenu && (
              <div className="absolute top-full right-0 mt-2 w-48 bg-white dark:bg-surface-dark border border-slate-200 dark:border-white/10 rounded-2xl shadow-2xl overflow-hidden animate-[modalScaleUp_0.2s_ease-out] z-50">
                <div className="p-2">
                  <button 
                    onClick={() => {
